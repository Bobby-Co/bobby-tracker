...
// The Ucelot ("Bobby") brand mark, in a 106×102 viewBox. Exported as a raw path
// string too so non-SVG surfaces (e.g. the setup wizard's canvas physics sim)
// can build a Path2D from the same source of truth.
export const BOBBY_MARK_PATH =
