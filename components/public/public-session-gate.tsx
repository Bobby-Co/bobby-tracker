...
export function PublicSessionGate({
    ...
    return (
        <main className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center gap-5 px-4 py-12 sm:px-6">
            <div className="anim-fade flex w-full flex-col items-center gap-4 rounded-[16px] border border-[color:var(--c-border)] bg-[color:var(--c-surface)] p-6 text-center shadow-[var(--shadow-card)] sm:p-8">
                <span className="grid h-12 w-12 place-items-center rounded-full bg-[color:var(--c-surface-2)] text-[color:var(--c-text-muted)]">
