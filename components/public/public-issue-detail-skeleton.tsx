// Shared skeleton for the per-issue public detail page. Used by the
// route's loading.tsx and the in-page Suspense fallback so both hard
// and soft navigations render the same layout instantly.
export function PublicIssueDetailSkeleton() {
    return (
        <main
            aria-busy
