...
export default function NewsletterForm() {
    ...
    return (
        <form onSubmit={onSubmit} className="mt-4">
            ...
            <div className="flex max-w-sm items-center gap-2 rounded-sq-l border border-[#0a0d1c]/12 bg-white p-1.5 focus-within:border-[#0a0d1c]/25">
                <input
                    id="nl-email"
                    type="email"
                    required
                    ...
                    autoComplete="email"
                    className="min-w-0 flex-1 bg-transparent px-2.5 py-1.5 text-[13.5px] text-[#0a0d1c] outline-none placeholder:text-[#0a0d1c]/35"
                />
                <button
                    type="submit"
                    disabled={state === "sending"}
                    className="shrink-0 rounded-sq bg-[#0a0d1c] px-3.5 py-2 text-[12.5px] font-bold text-[#fffae8] transition-opacity hover:opacity-90 disabled:opacity-50"
                >
