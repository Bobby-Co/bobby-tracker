...
export const IconlyMessage = ({ size = 16, color = "currentColor", secondColor = "currentColor" }: IconlyIconProps) => {
    return (
		<svg width={size} height={size} viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
		    ...
		    <g id="Iconly/Bold/Message" stroke="none" strokeWidth="1.5" fill="none" fillRule="evenodd">
		        <g id="Message" transform="translate(2.000400, 3.000000)" fill={secondColor} fillRule="nonzero">
