            ...
            <div className="w-full max-w-md rounded-[20px] border border-[color:var(--c-border)] bg-white p-7 shadow-[var(--shadow-card)]">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 className="text-[16px] font-bold leading-tight">Link this device</h1>
                    </div>
                </div>

                <p className="mt-4 text-[13px] text-[color:var(--c-text-muted)]">
                    Confirm pairing so this Mac can power analysis with your local LLM.
                </p>
...
const BobbyMark = () => (
    <svg width={32} height={32} viewBox="0 0 106 102" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path
            fill="black"
